...
/**
React에서는 게시판의 목록과 같이 반복적으로 출력되는 요소에 unique한 key라는 이름의 prop을 추가하도록 
권고하고 있다. 따라서 위와같이 배열의 인덱스나 중복되지 ㅇ낳는 일련번호 등을 부여해야 한다. 그렇지 않으면
Warning: Each child in a list should have a unique "key" prop. 이라는 경고가 발생한다.
 */
/**
