  ...
  return (<>
    <div className="player">
      <span className="player-name">
        ...
        <a href="/" onClick={(e)=>{e.preventDefault(); setShowEdit(!showEdit);}}>{playerRow.name}</a>
      </span>
      <Counter idx={playerRow.idx} score={playerRow.score} />
    </div>
    {
      (showEdit === false) ? '' : <EditPlayerForm pIdx={playerRow.idx} pName={playerRow.name} setShowEdit={setShowEdit} />
    }
  </>);
}