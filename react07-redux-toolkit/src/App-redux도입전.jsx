...
/**  
부모 컴포넌트인 App에서 프롭스를 통해 내려받은 함수를 다시 자식 
컴포넌트로 전달한다. 이렇게 순차적으로 전달하는것을 '프롭드릴링'
이라고 한다. */
const Right1 = (props) => {
  return (
    <div>
      <h2>Right1</h2>
      {/* App에서 전달받은 onMyPlus1() 함수를 onMyPlus2로 
      다시 전달 */}
      <Right2 onMyPlus2={()=>{
        props.onMyPlus1();
      }}></Right2>
...
const Right3 = (props) => {
  return (
    <div>
      <h2>Right3</h2>
      {/* Right의 최하위 컴포넌트에서는 Click 이벤트를 통해 
  ...
  return (<>
    <div className='root'>
      ...
      <div id='grid'>
        ...
        {/* Right 컴포넌트 하위로는 상태 변경을 위한 함수를 전달 */}
        <Right1 onMyPlus1={()=>{
          setNumber(number + 1);
        }}></Right1>
      </div>
